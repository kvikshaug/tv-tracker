...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('core_show', 'last_seen', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)

        # Adding field 'Show.comments'
        db.add_column('core_show', 'comments', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Show.last_seen'
        db.delete_column('core_show', 'last_seen')

        # Deleting field 'Show.comments'
        db.delete_column('core_show', 'comments')
